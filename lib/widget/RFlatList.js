...
export default class RFlatList extends PureComponent {
    ...
    render() {
        ...
        return <ViewTag refreshing={status === RFlatList.RefreshStatus.RefreshingData}
                        ...
                        refreshControl={<RefreshControl onRefresh={() => onRefresh()} refreshing={status === RFlatList.RefreshStatus.RefreshingData} progressViewOffset={selfOr(indicatorOffset, 50)}/>}
                        ...
                        onMomentumScrollBegin={() => this.loadMoreTag = true}
