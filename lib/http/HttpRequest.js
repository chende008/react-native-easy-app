...
export default class HttpRequest {
    ...
    constructor() {
        this.data = {
            ...
            serverTag: RFHttpConst.ServerTag,// request protocol config Tag
        };
        HttpConfig[RFHttpConst.ServerTag] || new HttpConfig(RFHttpConst.ServerTag); // make sure base config
    }
