...
export default class RFStorage {
    ...
    static initStorage(storageObj, initializedFunc, dataChangedFunc, version, storageImp) {
        if (isEmpty(storageObj) || isEmpty(initializedFunc)) return 'invalid parameter';
    ...
    static syncInitStorage(storageObj, dataChangedFunc, version, storageImp) {
        return new Promise((resolve, reject) => {
            let errorMsg = RFStorage.initStorage(storageObj, () => resolve(true), dataChangedFunc, version, storageImp);
